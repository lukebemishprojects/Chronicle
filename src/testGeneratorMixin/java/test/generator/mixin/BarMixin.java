...
public interface BarMixin extends MapMixin<Bar> {
    default void gizmo(@DelegatesTo(value = Gizmo.class, strategy = Closure.DELEGATE_FIRST) Action<Gizmo> action) {
        MapMixin.backend(this).configure("gizmo", action, Gizmo.class);
    }
}
